  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p><b style="color:red">Thông Báo : Chào Mừng Bạn Đến Với Trang Chủ Dragon Baby Boy</b></p>
            <b><p class="mb-0" style="color:red">Gifcode sịn sò, không ngon không lấy xiền hehe</p></b>
            <b><p class="mb-0" style="color:red">Nhóm Tin Tức Từ Đội Ngũ Admin Dragon Baby Boy</p></b>
            <b><p class="mb-0" style="color:red">Thân ái, Dragon Baby Boy</p></b>
        </div>
...
<h2 class="fw-light">Dragon Baby Boy</h2>
 <?php if($_login == null) { ?>
...
<div class="center">
    <div class="title-behavior">
        <marquee behavior="scroll" direction="left">Chào mừng bạn đến với máy chủ Dragon Baby boy, Đội ngũ Admin chúc các bạn có những trải nghiệm tuyệt vời khi tham gia vào máy chủ của Dragon Baby boy</marquee>
    </div>
</div>
<style>
    .center {
...
<div class="box_name_eman">bởi <b><b><font style="color:red">Admin đẹp trai</font></b></b> - <span> Xem chi tiết tại đây !!! </span> </div>
</div>
</div>
